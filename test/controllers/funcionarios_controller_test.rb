...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { ativo: @funcionario.ativo, salario: @funcionario.salario, usuario: @funcionario.usuario } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { ativo: @funcionario.ativo, salario: @funcionario.salario, usuario: @funcionario.usuario } }
